...
class _HomeTabPageState extends State<HomeTabPage>
{
  ...
  //code for asking permission for location
  ...
  {
    //gives the exact current position of user
  ...
  Widget build(BuildContext context) {
    return Stack(
      children: [
        ...
        //button for online ofline driver
        Positioned(
